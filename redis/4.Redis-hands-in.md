...
# 소스 확인
$ cat ~/githubrepo/ktds-edu-redis/redis/PythonSample/11.spt-cluster.py
...
# 소스 확인
$ cat ~/githubrepo/ktds-edu-redis/redis/PythonSample/15.spt-redis-mr-in.py


# 실행
$ cd ~/githubrepo/ktds-edu-redis/redis/PythonSample
  python 15.spt-redis-mr-in.py
