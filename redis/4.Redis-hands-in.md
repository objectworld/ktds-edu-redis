...
본 문서에서는 01 (예를들면 user01) 번으로 설정한 script 들이 존재한다.
...
# 실행
$ cd ~/githubrepo/ktds-edu-redis/redis/PythonSample
  python 15.spt-redis-mr-set.py ds-redis-master.redis-mr.svc 6379 user01 10000
...
# 실행
$ cd ~/githubrepo/ktds-edu-redis/redis/PythonSample
  python 16.spt-redis-mr-get.py ds-redis-master.redis-mr.svc 6379 user01 10000
